/*****************************************************************************
* Filename:          D:\fpga_project\cpu\23/drivers/i2c_software_master_v1_00_a/src/i2c_software_master_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the i2c_software_master driver
...
XStatus I2C_SOFTWARE_MASTER_SelfTest(void * baseaddr_p)
{
  ...
  I2C_SOFTWARE_MASTER_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = I2C_SOFTWARE_MASTER_mReadSlaveReg0(baseaddr, 0);
