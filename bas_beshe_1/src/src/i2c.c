...
boolean scl_read()
{
	return ((I2C_mReadSlaveReg0(i2c_base_address,I2C_SLV_REG0_OFFSET)&(1<<(28)))&&1 );
}

boolean sda_read()
{

	return ((I2C_mReadSlaveReg0(i2c_base_address,I2C_SLV_REG0_OFFSET)&(1<<(29)))&&1);
}
void sda_write(boolean val)
{
	...
	if(val)
		...
		((scl_last<<30)&(~(1<<31)));
	sda_last=val;
	I2C_mWriteSlaveReg0(i2c_base_address, I2C_SLV_REG0_OFFSET, out);
	delay_ns(10);
