/*****************************************************************************
* Filename:          F:\xilinx\embeded_development_kit\14.7\ISE_DS\edk_user_repository\MyProcessorIPLib/drivers/timer_v1_00_a/src/timer.h
* Version:           1.00.a
...
#define TIMER_SLV_REG2_OFFSET (TIMER_USER_SLV_SPACE_OFFSET + 0x00000008)
...
#define TIMER_mWriteSlaveReg2(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (TIMER_SLV_REG2_OFFSET) + (RegOffset), (Xuint32)(Value))
...
#define TIMER_mReadSlaveReg2(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (TIMER_SLV_REG2_OFFSET) + (RegOffset))
