/*****************************************************************************
* Filename:          D:\fpga_project\cpu\17/drivers/usart_v1_00_a/src/usart_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the usart driver
* Date:              Wed Aug 01 02:24:43 2018 (by Create and Import Peripheral Wizard)
*****************************************************************************/
...
XStatus USART_SelfTest(void * baseaddr_p)
{
  ...
  USART_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = USART_mReadSlaveReg0(baseaddr, 0);
  ...
  USART_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = USART_mReadSlaveReg1(baseaddr, 0);
  ...
  xil_printf("   - slave   write/read passed\n\n\r");
