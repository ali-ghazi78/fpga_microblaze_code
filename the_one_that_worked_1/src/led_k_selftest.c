/*****************************************************************************
* Filename:          D:\fpga_project\cpu\23/drivers/led_k_v2_00_a/src/led_k_selftest.c
* Version:           2.00.a
* Description:       Contains a diagnostic self-test function for the led_k driver
...
XStatus LED_K_SelfTest(void * baseaddr_p)
{
  ...
  LED_K_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = LED_K_mReadSlaveReg0(baseaddr, 0);
